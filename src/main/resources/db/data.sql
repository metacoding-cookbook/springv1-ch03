...
insert into board_tb (title, content, created_at,user_id) values ('title1', 'Spring Boot Study 1', now(),1); 
insert into board_tb (title, content, created_at,user_id) values ('title2', 'Spring Boot Study 2', now(),1); 
